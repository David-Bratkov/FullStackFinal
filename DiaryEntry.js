...
const diarySchema = new mongoose.Schema(
    {
        /**
        * References the user who created the diary entry.
        *
        * - type: ObjectId the unique identifier used by MongoDB for documents
        * - ref: "User"
        a reference to the User model
        *
        * When retrieving a diary entry, you can use Mongoose's populate()
        * method to include the full user details (name, email, etc.) by
